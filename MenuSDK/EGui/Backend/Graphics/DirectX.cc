...
EGUI_API bool Graphics::CreateD3D()
{
...
EGUI_API void Graphics::CreateD3DPP()
{
...
EGUI_API bool Graphics::CreateD3DDevice()
{
...
EGUI_API bool Graphics::BeginScene()
{
